...
/**
 * Any data type for CWL.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public final class CWLAnyType extends CWLSimpleDataType {
    ...
    private static final class InstanceHolder {
      static final CWLAnyType INSTANCE = new CWLAnyType();
    }

    /**
     * @return a singleton instance of this type.
     */
    public static CWLAnyType getInstance() {
