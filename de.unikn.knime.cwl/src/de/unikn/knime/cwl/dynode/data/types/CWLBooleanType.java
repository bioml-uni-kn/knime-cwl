...
/**
 * Boolean data type for CWL.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public final class CWLBooleanType extends CWLSimpleDataType {
    
    private CWLBooleanType() {
        super(CWLType.BOOLEAN);
    }
    ...
    private static final class InstanceHolder {
      static final CWLBooleanType INSTANCE = new CWLBooleanType();
    }

    /**
     * @return a singleton instance of this type.
     */
    public static CWLBooleanType getInstance() {
