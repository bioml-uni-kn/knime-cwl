...
/**
 * Directory data type for CWL.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public final class CWLDirectoryType extends CWLSimpleDataType {
    
    private CWLDirectoryType() {
        super(CWLType.DIRECTORY);
    }
    ...
    private static final class InstanceHolder {
      static final CWLDirectoryType INSTANCE = new CWLDirectoryType();
    }

    /**
     * @return a singleton instance of this type.
     */
    public static CWLDirectoryType getInstance() {
