...
/**
 * Double data type for CWL.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public final class CWLDoubleType extends CWLSimpleDataType {
    
    private CWLDoubleType() {
        super(CWLType.DOUBLE);
    }
    ...
    private static final class InstanceHolder {
      static final CWLDoubleType INSTANCE = new CWLDoubleType();
    }

    /**
     * @return a singleton instance of this type.
     */
    public static CWLDoubleType getInstance() {
