...
/**
 * File data type for CWL.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public final class CWLFileType extends CWLSimpleDataType {
    ...
    private static final class InstanceHolder {
      static final CWLFileType INSTANCE = new CWLFileType();
    }

    /**
     * @return a singleton instance of this type.
     */
    public static CWLFileType getInstance() {
