...
/**
 * Float data type for CWL.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public final class CWLFloatType extends CWLSimpleDataType {
    
    private CWLFloatType() {
        super(CWLType.FLOAT);
    }
    ...
    private static final class InstanceHolder {
      static final CWLFloatType INSTANCE = new CWLFloatType();
    }

    /**
     * @return a singleton instance of this type.
     */
    public static CWLFloatType getInstance() {
