...
/**
 * Integer data type for CWL.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public final class CWLIntegerType extends CWLSimpleDataType {
    
    private CWLIntegerType() {
        super(CWLType.INT);
    }
    ...
    private static final class InstanceHolder {
      static final CWLIntegerType INSTANCE = new CWLIntegerType();
    }

    /**
     * @return a singleton instance of this type.
     */
    public static CWLIntegerType getInstance() {
