...
/**
 * Long data type for CWL.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public final class CWLLongType extends CWLSimpleDataType {
    ...
    private static final class InstanceHolder {
      static final CWLLongType INSTANCE = new CWLLongType();
    }

    /**
     * @return a singleton instance of this type.
     */
    public static CWLLongType getInstance() {
