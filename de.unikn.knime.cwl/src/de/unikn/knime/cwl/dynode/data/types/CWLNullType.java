...
/**
 * Null data type for CWL.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public final class CWLNullType extends CWLSimpleDataType {
    ...
    private static final class InstanceHolder {
      static final CWLNullType INSTANCE = new CWLNullType();
    }

    /**
     * @return a singleton instance of this type.
     */
    public static CWLNullType getInstance() {
