...
/**
 * String data type for CWL.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public final class CWLStringType extends CWLSimpleDataType {
    
    private CWLStringType() {
        super(CWLType.STRING);
    }
    ...
    private static final class InstanceHolder {
      static final CWLStringType INSTANCE = new CWLStringType();
    }

    /**
     * @return a singleton instance of this type.
     */
    public static CWLStringType getInstance() {
