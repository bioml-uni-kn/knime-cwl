...
/**
 * Node set factory for the nodes converting between CWL ports.
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 *
 */
public class AnyToSpecificNodeSetFactory implements NodeSetFactory {

    /** Config key for the type setting. */
    public static final String CFG_TYPE = "type";

    private static final String ID_PREFIX = "org.knime.cwl.anyto.";
    ...
    public Class<? extends NodeFactory<? extends NodeModel>> getNodeFactory(final String id) {
        return AnyToSpecificNodeFactory.class;
    }
