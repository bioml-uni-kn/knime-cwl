...
/**
 * Factory for the CWL Input nodes.
 *
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 */
public class CWLInputNodeFactory 
        extends NodeFactory<CWLInputNodeModel> {
    
    private static final NodeLogger LOGGER = NodeLogger.getLogger(CWLInputNodeFactory.class);
     ...
     */
    @Override
    public CWLInputNodeModel createNodeModel() {
        return new CWLInputNodeModel(m_type);
    }
     ...
     */
    @Override
    public NodeView<CWLInputNodeModel> createNodeView(final int viewIndex,
            final CWLInputNodeModel nodeModel) {
        return null;
    }
    ...
    protected NodeDescription createNodeDescription() throws SAXException, IOException, XmlException {
        try {
            ...
            node.setName(String.format("CWL %s Input", niceType));
            
            node.setIcon("./jsontocwl.png");
            node.setType(KnimeNode.Type.OTHER);
            
            String descr = String.format("Creates a CWL Port of type %s from user input.", niceType);
