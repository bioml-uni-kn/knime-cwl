...
/**
 * Node model for the CWL Port to Json node.
 * 
 * @author Martin Horn, Alexander Fillbrunn: University of Konstanz
 */
public class CWLPortToJSONNodeModel extends NodeModel {

    /**
     * Creates a new instance of {@code CreateRecordNodeModel}.
     */
    public CWLPortToJSONNodeModel() {
    ...
    private DataTableSpec createSpec() {
        return new DataTableSpecCreator()
                .addColumns(new DataColumnSpecCreator(m_colName.getStringValue(), JSONCell.TYPE).createSpec())
                .createSpec();
    }
     ...
     */
    public static final SettingsModelString createColumnNameSettingsModel() {
        return new SettingsModelString("columnName", "CWL Content");
    }
    ...
    protected PortObject[] execute(final PortObject[] inData, final ExecutionContext exec) throws Exception {
        ...
        BufferedDataContainer dc = exec.createDataContainer(createSpec());
        dc.addRowToTable(new DefaultRow(new RowKey("CWL Content"), JSONCellFactory.create(cwl.getJsonContent())));
        dc.close();
